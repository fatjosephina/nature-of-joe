...
public class Ecosystem6 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            boids.Add(new BoidE(mousePos, minimumPos, maximumPos, maxSpeed, maxForce, coneMesh, new BoidParent(Vector2.zero, Vector2.zero, Vector2.zero, 5f, 5f, new List<BoidE>())));
        }*/
    }
...
class BoidE
{
    ...
    public void Flock(List<BoidE> boids)
    {
    ...
    public Vector2 Align(List<BoidE> boids)
    {
    ...
    public Vector2 Cohesion(List<BoidE> boids)
    {
    ...
    public Vector2 Separate(List<BoidE> boids)
    {
        Vector2 sum = Vector2.zero;
        int count = 0;
