...
public class Chapter1E8 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mover.acceleration = mover.multiplyVector(dir.normalized, Mathf.Pow(0.5f, 1f / dir.magnitude));
        mover.Update();
    }
    ...
    {
        float scaledAcceleration;
        scaledAcceleration = mover.subtractVectors(mousePos, mover.location);
